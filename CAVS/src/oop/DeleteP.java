...
Toolkit.getDefaultToolkit().getSystemEventQueue().postEvent(winClosingEvent);
    ...
    private void initComponents() {
        ...
        btndelete.setFont(new java.awt.Font("Rockwell Condensed", 1, 20)); // NOI18N
        btndelete.setIcon(new javax.swing.ImageIcon("C:\\Users\\ghel_loe\\Pictures\\Saved Pictures\\dels.png")); // NOI18N
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
             if(SQLite.openDB()){
            String prodID= this.txtprodID.getText();
            if(SQLite.delete("Product", prodID) && !this.txtprodID.getText().trim().isEmpty()){
