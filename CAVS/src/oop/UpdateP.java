...
Toolkit.getDefaultToolkit().getSystemEventQueue().postEvent(winClosingEvent);
    ...
    private void initComponents() {
        ...
        btnupdate.setFont(new java.awt.Font("Rockwell Condensed", 1, 20)); // NOI18N
        btnupdate.setIcon(new javax.swing.ImageIcon("C:\\Users\\ghel_loe\\Pictures\\Saved Pictures\\ed1.png")); // NOI18N
        ...
        btnsearch.setIcon(new javax.swing.ImageIcon("C:\\Users\\ghel_loe\\Pictures\\Saved Pictures\\findss.png")); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtbrandname, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        if(SQLite.openDB()){
          String ProdNo = this.txtprodID.getText();
            String prodName= this.txtprodname.getText();
            String rp = this.txtrp.getText();
            String sp = this.txtsp.getText();
            String brandname = this.txtbrandname.getText();
            int qty = Integer.parseInt(this.txtqty.getText());
            String set ="product_name="+"'"+prodName+"'"+","+"selling_price="+sp+","+"quantity="+qty+","+"remaining_product="+rp+","+"brand_name="+"'"+brandname+"'";
             
            if(SQLite.update("Product",set,ProdNo)){
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        if(SQLite.openDB()){
            String[][] records = SQLite.read("Product");
            ...
            if(result){
                txtprodID.setText(records[foundRecord][0]);
                txtprodname.setText(records[foundRecord][1]);
                //  txtLastName.setText(records[foundRecord][3]);
                txtsp.setText(records[foundRecord][2]);
                txtqty.setText(records[foundRecord][3]);
                txtrp.setText(records[foundRecord][4]);
                txtbrandname.setText(records[foundRecord][5]);
                javax.swing.JOptionPane.showMessageDialog(null, "ID found");
            }
            else{
                javax.swing.JOptionPane.showMessageDialog(null, "ID not found");
            }
            SQLite.closeDB();
        }
